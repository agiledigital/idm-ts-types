...
interface OpenIDM {
    create: (resourceName: string, newResourceId: string, content: object, params?: object, fields?: string[]) => Result
    patch: (resourceName: string, rev: string, value: object, params?: object, fields?: string[]) => Result
    read: (resourceName: string, params?: object, fields?: string[]) => (Result | null)
    update: (resourceName: string, rev: string, value: object, params?: object, fields?: string[]) => Result
    delete: (resourceName: string, rev: string, params?: object, fields?: string[]) => Result
    query: (resourceName: string, params: QueryFilter, fields?: string[]) => QueryResult<Result>
    action: (resource: string, actionName: string, content: object, params?: object, fields?: string[]) => any
...
interface IdentityServer {
    getProperty: (name: string, defaultVal: string, substitute?: boolean) => string
